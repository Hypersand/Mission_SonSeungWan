...
public class LikeablePersonControllerTests {
    ...
    void t001() throws Exception {
        ...
        ResultActions resultActions = mvc
                .perform(get("/usr/likeablePerson/add"))
                .andDo(print());
    ...
    void t012() throws Exception {
        ...
        for (int i = 0; i <= AppConfig.getLikeablePersonFromMax(); i++) {
            likeablePersonService.like(memberUser5, "insta_user" + i, 1);
        }
    ...
    void t013() throws Exception {
        ...
        Optional<LikeablePerson> opLikeablePerson = likeablePersonService.findById(1L);
